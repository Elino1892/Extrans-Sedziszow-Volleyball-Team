...
const TableLeague = () => {
  return (
    <div className="league-table">
      <h2 className="league-table__title">Sezon 2021/2022</h2>
      <table className="league-table__container">
        ...
        <tbody className="league-table__table-body">
          <tr className="league-table__table-body-line">
            <td>1</td>
            <td><img src={firstTeamLogo} alt="" className="league-table__table-body-image"></img></td>
          ...
          <tr className="league-table__table-body-line">
            <td>2</td>
            <td><img src={secondTeamLogo} alt="" className="league-table__table-body-image"></img></td>
            <td>MKS Andrychów</td>
            <td>36</td>
            <td>15</td>
          </tr>
          <tr className="league-table__table-body-line">
            <td>3</td>
            <td><img src={thirdTeamLogo} alt="" className="league-table__table-body-image"></img></td>
            <td>Karpaty Krosno Glass - KPU w Krośnie</td>
            <td>31</td>
            <td>15</td>
          </tr>
          <tr className="league-table__table-body-line league-table__table-body-line--highlighted">
            <td>6</td>
            <td><img src={sedziszowTeamLogo} alt="" className="league-table__table-body-image"></img></td>
