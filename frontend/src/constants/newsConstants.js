...
export const NEWS_LAST_REQUEST = 'NEWS_LAST_REQUEST'
export const NEWS_LAST_SUCCESS = 'NEWS_LAST_SUCCESS'
export const NEWS_LAST_FAIL = 'NEWS_LAST_FAIL'

export const NEWS_CREATE_COMMENT_REQUEST = 'NEWS_CREATE_COMMENT_REQUEST'
export const NEWS_CREATE_COMMENT_SUCCESS = 'NEWS_CREATE_COMMENT_SUCCESS'
export const NEWS_CREATE_COMMENT_FAIL = 'NEWS_CREATE_COMMENT_FAIL'
export const NEWS_CREATE_COMMENT_RESET = 'NEWS_CREATE_COMMENT_RESET'
...
export const NEWS_DELETE_COMMENT_FAIL = 'NEWS_DELETE_COMMENT_FAIL'
export const NEWS_DELETE_COMMENT_RESET = 'NEWS_DELETE_COMMENT_RESET'