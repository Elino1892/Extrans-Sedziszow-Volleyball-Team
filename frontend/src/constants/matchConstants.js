...
export const MATCH_LAST_LIST_REQUEST = 'MATCH_LAST_LIST_REQUEST'
export const MATCH_LAST_LIST_SUCCESS = 'MATCH_LAST_LIST_SUCCESS'
export const MATCH_LAST_LIST_FAIL = 'MATCH_LAST_LIST_FAIL'
export const MATCH_LAST_LIST_RESET = 'MATCH_LAST_LIST_RESET'
